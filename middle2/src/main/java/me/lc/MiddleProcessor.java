...
public class MiddleProcessor extends Thread {
    ...
    public MiddleProcessor() {
        ...
        context.start();
        LOGGER.info("middle processor 2 ready!");
    ...
    @Override
    public void run() {
        URL urlDataSrc = new URL("http://localhost:" + Constants.DATA_SOURCE_PORT + "/trace2.data");
        ...
        LOGGER.info("middle processor 2 load data...");
        ...
        inputStream.close();
        LOGGER.info("middle processor 2 read from socket finish");
        READ_FINISH = true;
    }
